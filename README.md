...
<p align="center">
  Desarrollador Full Stack en formación · Java y Web<br>
  Madrid, España
</p>
...
Estudiante de Desarrollo de Aplicaciones Web (DAW) en busca de prácticas como desarrollador Full Stack. Vengo del soporte informático, así que sé resolver problemas y trabajar con usuarios reales. Me interesa el código claro y bien estructurado.
...
- **Visualizador 3D de skins de CS2:** aplicación web con WebGL. Próximo paso: API propia con Spring Boot y PostgreSQL.
